...
IconButton::IconButton(sf::IntRect rectangle, Forest& forest, std::function<void()> onClick, const wiz::AssetLoader& assetLoader, const wiz::TextureAsset* textureType) : Button(rectangle, forest, onClick) {
    float scale = 3.0f;
